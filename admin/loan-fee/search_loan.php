...
<?php
    ...
    if(isset($x) && $x == 0){
        head(); 
        $search = "<div class = 'S'>";
        $search .= "<form action='http://localhost/admin/loan-fee/search_loan.php' method='post' id='form1'>";
        ...
        if (isset($_POST["id"])){
            ...
            if ($result->num_rows > 0) {
                ...
                $tabla .= "<th>Date to return</th><th></th></tr>";//header row
                ...
                echo "<div class = 'Ws'>There are no active loans with this ID at the moment</div> ";
